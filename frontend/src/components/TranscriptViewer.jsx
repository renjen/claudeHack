  ...
  return (
    <div className="bg-gray-900 rounded-2xl p-5 flex flex-col gap-3 border border-gray-800">
      <div className="flex items-center justify-between">
        <span className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Your Statement</span>
        <span className="text-xs px-2 py-0.5 bg-gray-800 rounded-full text-gray-400 font-mono border border-gray-700">
